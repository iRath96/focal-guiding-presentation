import {Circle, Latex, Layout, Line, Ray, Txt, makeScene2D} from '@motion-canvas/2d';
import {SimpleSignal, all, createRef, createSignal} from '@motion-canvas/core';
import { Curve2f, Line2f, Ray2f, Vector2f, curve2f_eval, curve2f_intersect, curve2f_normal, line2f_intersect, mat33f_multiply, ray2f_evaluate, vec2f, vec2f_add, vec2f_multiply, vec2f_normalized, vec2f_polar, vec2f_refract, vec3f, vec3f_homogeneous_project } from '../rt/math';
...
export default makeScene2D(function* (view) {
    ...
    yield* curvature(-1e-5, 0).to(-0.3, 2).to(-1e-5, 4)
});
